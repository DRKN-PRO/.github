...
![AI intelligence](https://img.shields.io/badge/AI-intelligence-8B5CF6?style=flat-square)
![Crypto markets](https://img.shields.io/badge/crypto-market%20context-111827?style=flat-square)
![Risk awareness](https://img.shields.io/badge/risk-explainable-10B981?style=flat-square)
![Automation](https://img.shields.io/badge/automation-controlled-0F172A?style=flat-square)
...
```mermaid
flowchart LR
    D[Account and market data] --> I[DRKN intelligence layer]
    I --> A[Account Lab]
    I --> C[Copilot]
    I --> W[Controlled automations]
    A --> U[Clearer decisions]
    C --> U
    W --> U

    classDef input fill:#020617,stroke:#64748b,color:#f8fafc
    classDef core fill:#0f172a,stroke:#8b5cf6,color:#f8fafc
    classDef product fill:#111827,stroke:#10b981,color:#f8fafc
    class D input
    class I core
    class A,C,W,U product
```
